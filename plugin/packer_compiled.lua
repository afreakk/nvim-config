...
_G.packer_plugins = {
  ...
  ["fzf-checkout.vim"] = {
    loaded = true,
    path = "/home/afreak/.local/share/nvim/site/pack/packer/start/fzf-checkout.vim"
  },
  ["fzf.vim"] = {
    loaded = true,
  ...
  ["nginx.vim"] = {
    loaded = false,
    needs_bufread = true,
    path = "/home/afreak/.local/share/nvim/site/pack/packer/opt/nginx.vim"
  },
  ["nredir.nvim"] = {
    commands = { "Nredir" },
    loaded = false,
  ...
  ["nvim-dap-ui"] = {
    loaded = true,
    path = "/home/afreak/.local/share/nvim/site/pack/packer/start/nvim-dap-ui"
  },
  ["nvim-treesitter"] = {
    loaded = true,
  ...
  undotree = {
    ...
    loaded = true,
    path = "/home/afreak/.local/share/nvim/site/pack/packer/start/undotree"
  },
  ["vim-choosewin"] = {
  ...
  ["vim-graphql"] = {
    loaded = true,
    path = "/home/afreak/.local/share/nvim/site/pack/packer/start/vim-graphql"
  },
  ["vim-indent-object"] = {
    loaded = true,
...
try_loadstring("\27LJ\2\n\v\0\0\1\0\0\0\1K\0\1\0\0", "config", "undotree")
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Nredir lua require("packer.load")({'nredir.nvim'}, { cmd = "Nredir", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
time([[Sourcing ftdetect script at: /home/afreak/.local/share/nvim/site/pack/packer/opt/nginx.vim/ftdetect/nginx.vim]], true)
vim.cmd [[source /home/afreak/.local/share/nvim/site/pack/packer/opt/nginx.vim/ftdetect/nginx.vim]]
time([[Sourcing ftdetect script at: /home/afreak/.local/share/nvim/site/pack/packer/opt/nginx.vim/ftdetect/nginx.vim]], false)
vim.cmd("augroup END")
